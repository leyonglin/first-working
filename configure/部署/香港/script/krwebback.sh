...
$Rsync -avz --password-file=/opt/scripts/.rsyncd.passwd --port 1873   /opt/backup/data_views_nginx/ rsync@krdataback.zhushuqt.com::${token}_data_views_nginx >>/dev/null 2>&1
if [ $? -ne 0 ];then
